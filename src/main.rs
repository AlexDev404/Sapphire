...
fn kmain(vbe_mode_info: &VbeModeInfo) -> () {
    ...
    let hello_bytes = [
        ...
        b'W', b'o', b'r', b'l', b'd', b'!', 0 // Null-terminated
    ];
    ...
    let special_chars = [
        b'T', b'a', b'b', b':', b'\t', b'A', b'f', b't', b'e', b'r', b' ', b't', b'a', b'b', 0
    ];
    print_text(&special_chars, 0x3, 0x0, 30, 260, &vbe_mode_info);
    
    // Display system info
    let system_info = [
        b'S', b'a', b'p', b'p', b'h', b'i', b'r', b'e', b' ', b'O', b'S', b' ', 
        b'v', b'0', b'.', b'1', 0
    ];
    ...
    let row_label = [b'R', b'o', b'w', b'/', b'C', b'o', b'l', b' ', b'P', b'o', b's', b'i', b't', b'i', b'o', b'n', b'i', b'n', b'g', b':', 0];
